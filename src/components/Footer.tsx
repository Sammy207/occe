...
const Footer = () => {
  return (
    <footer id="contact" className="relative overflow-hidden">
      ...
      <div className="absolute top-20 left-20 w-32 h-32 bg-green-500/10 rounded-full animate-float"></div>
      <div className="absolute bottom-20 right-20 w-24 h-24 bg-yellow-500/10 rounded-full animate-float" style={{ animationDelay: '2s' }}></div>
      <div className="absolute top-1/2 right-1/4 w-16 h-16 bg-green-400/10 rounded-full animate-pulse-slow"></div>
        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div className="animate-slide-in-right" style={{ animationDelay: '0.4s' }}>
            ...
            <div className="modern-card bg-gray-800/50 p-6 hover-lift">
              ...
              <h4 className="font-semibold text-white hover:text-green-400 transition-colors cursor-pointer leading-relaxed">
                SA OCCE Backs Nestle's Safety Training as Model for Inclusive Climate Action
              </h4>
              <div className="mt-4 pt-4 border-t border-gray-700">
                <button className="text-green-400 hover:text-green-300 transition-colors text-sm font-medium inline-flex items-center group">
                  Read More 
